...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'blog_commentary', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('post', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['blog.Post'])),
            ('content', self.gf('django.db.models.fields.TextField')()),
            ('publication_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('author', self.gf('django.db.models.fields.CharField')(default=u'Uno que viene y dice... ', max_length=50)),
        ))
        db.send_create_signal(u'blog', ['Commentary'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'blog_commentary')
    ...
    models = {
        ...
        u'blog.commentary': {
            'Meta': {'ordering': "[u'-publication_date']", 'object_name': 'Commentary'},
            'author': ('django.db.models.fields.CharField', [], {'default': "u'Uno que viene y dice... '", 'max_length': '50'}),
